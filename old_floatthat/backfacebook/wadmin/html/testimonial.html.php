...
<?php if(isset($_SESSION['adminemail'])){} else {
		...
		<?php 
		$page_name="index.php?module=testimonial";
		
		
		$query2="SELECT * FROM tbl_testimonial";
...
<script type="text/javascript" src="openwysiwyg/scripts/wysiwyg.js"></script>
		...
		<?php if(isset($_GET['shfrm']) and $_GET['shfrm']=='addnew'){?>
			<form name="frm" action="index.php?module=testimonial" method="post">
           ...
           <tr><td colspan="2" align="left" style="padding-left:5px; " class="bheading" >Testimonial information</td></tr>
		   </table>
			...
			<table width="98%"  border="0" cellspacing="2" cellpadding="0" bgcolor="#DFDFDF" style="border:1px outset;margin-top:10px;" >
              ...
              <?php /*?>
               ...
               <tr bgcolor="#efefef">
                   <td  class="tdbord">Name: </td>
					<td  class="tdbord"><input type="text" name="name" value="<?php echo $this->paramss['News']['name'];?>" class="textBox"></td>
              </tr>
                <tr bgcolor="#efefef">
                   <td  class="tdbord">Designation: </td>
					<td  class="tdbord"><input type="text" name="company" value="<?php echo $this->paramss['News']['company'];?>" class="textBox"></td>
              </tr>
				<tr>
                   <td  class="tdbord">Comments: </td>
					<td  class="tdbord">
                     <script language="javascript">
							WYSIWYG.attach('detail1', full);
							</script>
                    
                    <textarea id="detail1" name="detail" cols="60" rows="4" style="border:1px solid #fff; background-color:#DFDFDF; color:#000; font-size:14px;"><?php echo $this->paramss['News']['comments'];?></textarea></td>
                </tr>
				 <tr bgcolor="#efefef">
				...
				<tr ><td class="tdbord"></td><Td align="left" style="padding-left:10px; " class="tdbord"><input type="submit" name="Regbtn" value="Save Testimonial" class="button"></Td></tr>
				<tr>
				  <td class="tdbord"></td>
		...
		<table width="98%"  border="0" cellspacing="3" cellpadding="3" bgcolor="#DFDFDF" style="border:1px outset;margin-top:10px;" >
           ...
           <tr><td class="bheading">Testimonial List</td><td  align="right" style="padding-right:30px; "><a href="index.php?module=testimonial&shfrm=addnew" class="para">Add Testimonial</a></td></tr>
	    </table>
		<br>
           ...
           <tr><td colspan="8" align="center"><?php echo $this->params['errorMsgDel'];?></td></tr>
               ...
               <tr bgcolor="#FFFFFF">
                ...
                <td  class="tdbord">Name</td>
                <td  class="tdbord">Designation</td>
				<td width="30%"  class="tdbord">Comments</td>
				...
				<td width="5%"  class="tdbord">Delete</td>
				 ...
				 <td class="tdbord"><?php echo $newslist['name'];?></td>
                  <td class="tdbord"><?php echo $newslist['company'];?></td>
				 <td class="tdbord"><?php echo $newslist['comments'];?></td>
				
				 <td class="tdbord"><?php if($newslist['status']==1){?><a href="index.php?module=testimonial&newac=<?php echo $newslist['t_id'];?>&st=0&start=<?php echo $start;?>" class="para" onClick="return condc();">Active</a><?php } else {?><a href="index.php?module=testimonial&newac=<?php echo $newslist['t_id'];?>&st=1&start=<?php echo $start;?>" class="para" onClick="return conac();">Disable</a><?php }?></td>
				 <td ><a href="index.php?module=testimonial&new_id=<?php echo $newslist['t_id'];?>&shfrm=addnew" class="tdbord">Edit</a></td>
				 <td ><a href="index.php?module=testimonial&del_id=<?php echo $newslist['t_id'];?>&start=<?php echo $start;?>" class="tdbord" onClick="return condel();">Delete</a></td>
				 </tr> 
				  <?php }
				  }
				  ?>                         	
