...
<div id="member"  style="width:800px; border:1px solid #CCC; margin-top:20px;" align="center">
...
<input type="hidden" name="user_id" id="user_id" value="<?php echo $user;?>" />
	...
	<table cellspacing="0" cellpadding="0" width="600">
    	...
    	<tr><td><div style="float:left; width:300px;"><h2>Creadit Card Information</h2></div></td></tr>
    <tr>
