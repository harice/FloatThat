...
<body>
	...
	<?php if($_GET['msg'] == "succ"){?>
				...
				<?php }?>
						...
						<form name="frmRegister" method="post" action="register-conf.php" onSubmit="return rsubmit();" enctype="multipart/form-data">
							<ol>
...
<!--
							...
							<ol>
								<li class="row clearfix">
									...
									<a href="#" onClick="rsubmit();" class="red_btn">Create Account</a>
									</div>
								</li>
							</ol>
						</form>
					...
					<input type="hidden" name="cart" id="cart" value="<?php echo $_GET['cart'];?>" />
							<ol>
								...
								<li class="row clearfix">
									<label class="input_tag" for="firstName">&nbsp;</label>
									<div class="inputOuter button">
									<a  href="#"onClick="ssubmit();" class="red_btn">Sign in</a>
                                    &nbsp;
                                    									</div>
