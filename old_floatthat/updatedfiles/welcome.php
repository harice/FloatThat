	...
	<div class="container">
		<div class="sixteen columns">
			...
			<div id="pageName">
				<div class="name_tag">
					<p>
						You're Here :: <a href="index.php">Home</a> :: Welcome and Thanks
					</p>
	...
	<div class="container">
			...
			<div id="user_log" class="clearfix">
				...
				<div class="seven columns">
					<div class="login">
						<div class="box_head" style="width: 500px;">
							<h3>Welcome <?php echo $userContents['name']?> to floatthat.net</h3>
						</div><!--end box_head -->

						<h6>&nbsp;</h6>
Thanks for visiting floatthat.net.
<!--Your Login informamtion on floatthat.net is as following:

<br /><br />
<strong>Login Email Address:</strong>&nbsp;<?php echo $userContents['email']?><br />
<strong>Password:</strong>&nbsp;<?php echo $userContents['password']?><br /><br />
<a href="change-password.php">Click here to Change Password</a>
<br /><br /><br />

From next time you can also directly login to FlatThat.com using above login information.-->
