...
margin-left: 10px;
    ...
    <div class="container sixteen columns">
		...
		<div class="latest">
			 <div class="box_head">
				<h3><?php if(!isset($_REQUEST['users_id']))
	 {?>
Who will participate with you please select Friends from <?php } else {?> The item cost will be divided by the number you selected, giving you a per user contribution amount<?php }?></h3>
