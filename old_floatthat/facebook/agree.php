...
<div id="member"  style="width:810px; border:1px solid #CCC; margin-top:20px;margin-left:170px;" align="center">
...
<input type="hidden" name="user_id" id="user_id" value="<?php echo $user;?>" />
	...
	<table cellspacing="0" cellpadding="0" width="750" align="center">
    	...
    	<tr><td colspan="2"><div style="float:left; width:750px;"><h2>No one will be charged until the selected odds are met and all participating members have accepted on float deal</h2></div></td></tr>
    <tr>
                                ...
                                <td valign="top" class="text" >
                                      ...
                                      <input type="text" size="12" id="inputField" name="closedate" value="<?php echo date('Y-m-d'); ?>"/>
                                </td>
                                </tr>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                               ...
                               <input type="text" name="cscnum" id="cscnum" maxlength="4" size="25"/>
                                ...
                                <td valign="top" class="text">
                               <input type="submit" value="" style="background-image:url(images/savedeal.jpg); width:200px; height:60px; border:none; cursor:pointer" name="savedeal" />
                                </td>
                                </tr>
                                 <tr><td colspan="2" height="15"></td></tr>
...
mysql_query("update tbl_deal set status='1',closedate='$floatdate' where deal_id=$deal_id");

mysql_query("insert into tbl_members(deal_id,user_id,date,status)values('$deal_id','$user_id','$date','1')");
			 	...
			 	$fuser=$frname['user_id'];
					...
					$statuss       = htmlentities($statuss, ENT_QUOTES);
      				...
      				$statusUpdate = $facebook->api("/$fuser/feed", 'post', array('picture'=> "$imgs",'link' => 'https://apps.facebook.com/floatthat/index.php?m=invitations&minvi=1','caption' => "visit here ",'name' => "$uname[name]", 'description' => $statuss, 'cb' => "$statuss"));
   ...
   <div class="mainhead"><?php echo $productdetail['title'];?> $<?php echo $productdetail['price'];   
   ...
   <div class="leftpanel">
     <div class="float_btn">
     	<a href="<?php echo $apppath;?>index.php?m=home" target="_top">
     ...
     <div class="greenarea">
    <div class="deal_on">Deal is done</div>
    <p>&nbsp;</p><p>&nbsp;</p>
     </div>
     </div>
   </div>
   <div class="ri8panel">
   <img src="wadmin/products/<?php echo $productdetail['c_id'];?>/<?php echo $productdetail['thumb'];?>" style="width:445px; height:266px;" alt="inner thumb" />
   <div class="social_butns"> <?php 
			$mainPath=$CanvasURL."wadmin/products/".$productdetail['c_id']."/".$productdetail['thumb'];
			
			$encoded_url=urlencode($mainPath.$productdetailt['pro_id']);?>
